...
var ENV = struct {
	...
	*/
	...
	DBConnectionStr string `env:"CLAMP_DB_CONNECTION_STR" envDefault:"host=34.216.32.148:5432 user=clamp dbname=clampdev password=clamppass"`
	/**
	Examples:
	...
	*/
	...
	QueueConnectionStr string `env:"CLAMP_QUEUE_CONNECTION_STR" envDefault:"amqp://clamp:clampdev!@34.216.32.148:5672/"`
	...
	*/
	...
	KafkaConnectionStr     string `env:"CLAMP_KAFKA_CONNECTION_STR" envDefault:"34.216.32.148:9092"`
