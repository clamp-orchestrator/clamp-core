...
// ENV is a config that is loaded at the application start up. The values here can be overridden by setting
// environment variables before the process starts up.
// An example of overriding the value would be `PORT` has a default value of `env:"APP_PORT" envDefault:"8080"`.
