...
func init() {
	up := func(db orm.DB) error {
		_, err := db.Exec("ALTER TABLE SERVICE_REQUESTS ADD COLUMN start_time time, ADD COLUMN end_time time, ADD COLUMN total_time_elapsed_ms int, ADD COLUMN steps jsonb;")
		return err
	}
