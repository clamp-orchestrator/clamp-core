...
func (m mockDB) GetWorkflows(pageNumber int, pageSize int, sortBy map[string]string, sortOrder []string) ([]models.Workflow, error) {
	return getWorkflowsMock(pageNumber, pageSize, sortBy, sortOrder)
}
...
var getWorkflowsMock func(pageNumber int, pageSize int, sortBy map[string]string, sortOrder []string) ([]models.Workflow, error)
