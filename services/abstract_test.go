...
func (m mockDB) GetWorkflows(pageNumber int, pageSize int, filters map[string]string) ([]models.Workflow, error) {
	return getWorkflowsMock(pageNumber, pageSize, filters)
}
...
var getWorkflowsMock func(pageNumber int, pageSize int, filters map[string]string) ([]models.Workflow, error)
