...
func (m mockDB) GetWorkflows(pageNumber int, pageSize int, sortBy map[string]string) ([]models.Workflow, error) {
...
var getWorkflowsMock func(pageNumber int, pageSize int, sortBy map[string]string) ([]models.Workflow, error)
