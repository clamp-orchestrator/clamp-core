...
func FindServiceRequestByID(serviceRequestID uuid.UUID) (*models.ServiceRequest, error) {
	...
	serviceRequest, err := repository.GetServiceRequestRepository().FindServiceRequestByID(serviceRequestID)
	if err != nil {
...
func SaveServiceRequest(serviceReq *models.ServiceRequest) (*models.ServiceRequest, error) {
	...
	serviceRequest, err := repository.GetServiceRequestRepository().SaveServiceRequest(serviceReq)
	if err != nil {
...
func FindServiceRequestByWorkflowName(workflowName string, pageNumber int, pageSize int) ([]*models.ServiceRequest, error) {
	...
	serviceRequests, err := repository.GetServiceRequestRepository().FindServiceRequestsByWorkflowName(workflowName, pageNumber, pageSize)
	if err != nil {
