...
func TestShouldCreateANewServiceRequestWithUUID(t *testing.T) {
	expectedLen := 16
	servRequest := NewServiceRequest("CreateOrder", nil)
...
func TestShouldCreateANewServiceRequestWithWorkflowName(t *testing.T) {
	...
	servRequest := NewServiceRequest(expectedWorkflowName, nil)
...
func TestThatGeneratedUUIDForServiceRequestAreDifferent(t *testing.T) {
	expectedWorkflowName := "CreateOrder"
	servRequestOne := NewServiceRequest(expectedWorkflowName, nil)
	servRequestTwo := NewServiceRequest(expectedWorkflowName, nil)
