...
// ToPGWorkflow converts a Workflow object into a Postgres specific workflow structure that is used for persisting to postgres specifically
...
// ToWorkflow converts a PGWorkflow struct to a Workflow structure that is used in the application to pass around a workflow definition.
