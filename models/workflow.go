...
// PGWorkflow is a struct which represents the structure of workflow record in the postgres data store.
// The Workflow struct is converted to PGWorkflow while saving and vice versa during retrieval.
...
// CreateWorkflow creates a new work flow with the given Workflow definition and step details. The workflow is persisted
